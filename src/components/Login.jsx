...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gradient-to-r from-green-300 to-green-500">
      <div className="bg-white p-8 shadow-lg rounded-lg max-w-sm w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <h7 className="text-gray-400 py-2 px-4" >Username: test and Password: password</h7>
        </form>
      </div>
    </div>
  );
