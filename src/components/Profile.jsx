...
const completedLength = (useSelector(state => state.compeleted) || []).length;
  ...
  return (
    <div className="mt-10 w-full md:w-1/4 lg:w-80 h-screen bg-[#EEF6EF] p-4 dark:text-white dark:bg-black flex flex-col">
      ...
      {/* Task Section */}
      <div className="bg-white dark:bg-[#2C2C2C] dark:text-white mt-4 rounded-md p-4">
        <div className="mb-4 flex flex-col">
          {[
            ...
            <div
              key={index}
              className="flex items-center space-x-3 text-md mb-2 p-2 rounded-md hover:bg-[#EEF6EF] cursor-pointer"
            >
              <Icon />
              <h1>{label}</h1>
            </div>
      ...
      {/* Add List Section */}
      <div className="mt-4 bg-white dark:bg-black dark:text-white rounded-md p-4 flex items-center space-x-3 hover:bg-[#EEF6EF] cursor-pointer">
        <IoMdAdd className="text-2xl" />
        <h2>Add List</h2>
      </div>

      {/* Graph Section */}
      <div className="mt-6 bg-white dark:bg-black dark:text-white rounded-md p-4">
